  ...
  return (
    <div className="flex flex-col items-center gap-y-12 w-full ">
      ...
      <div className="flex flex-col gap-y-4">
        ...
        <div>
        <button title="Comprar" className={`bg-yellow-400 ${cookies! >= (50 * nivel) ? "opacity-100 cursor-pointer" : "opacity-50 cursor-not-allowed"} flex flex-row justify-center items-center px-10 py-2`} disabled={cookies! < (50 * nivel) ? true : false} onClick={() => { setIsFirstRun(false); setNivel(nivel => nivel +1)} }>
